...
public class ServiceRestControllerWithWhitelistModeIT extends AbstractRestIT
{
    @Test
    ...
    @Test
    public void testBlockByNameWithCurrentlyAllowed()
    {
        // Preconditions
        repository.add(getBaseService().whitelisted());
    ...
    @Test
    public void testRedeployByNameWithWhitelistAllowed()
    {
        // Preconditions
        repository.add(getServiceWithAlreadyDeployed().whitelisted());
    ...
    @Test
    public void testRedeployByNameWithWhitelistBlocked()
    {
        // Preconditions
